...
export function ProjectCard({ project }: ProjectCardProps) {
  const cardClass =
    "group overflow-hidden rounded-[18px] border border-border bg-white transition-[transform,box-shadow] duration-300 hover:-translate-y-1.5 hover:shadow-[0_26px_60px_-30px_rgba(11,15,26,0.4)]";
